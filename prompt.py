...
4. Ambiguity Check — Does the requirement contain vague or subjective terms (e.g., “fast”, “user-friendly”)? Output: True (ambiguous) / False (not ambiguous).
5. Deadline — Does the requirement include a specific time constraint or deadline? Output: True / False.
6. Dependencies — Are there explicit dependencies on other systems, components, or processes mentioned? Output: True / False.
...
JSON Format:
{
  ...
  "AmbiguityCheck": { "value": true|false, "reason": "<one sentence>" },
